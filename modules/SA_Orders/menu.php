...
if (ACLController::checkAccess('SA_Orders', 'import', true)) {
    $module_menu[] = array('index.php?module=Import&action=Step1&import_module=SA_Orders&return_module=SA_Orders&return_action=index', $app_strings['LBL_IMPORT_ORDERS'], 'Import', 'SA_Orders');
}
if (ACLController::checkAccess('SA_Orders', 'import', true) &&
    ACLController::checkAccess('SA_OrderItems', 'import', true)) {
    $module_menu[] = array('index.php?module=Import&action=Step1&import_module=SA_OrderItems&return_module=SA_Orders&return_action=index', $app_strings['LBL_IMPORT_ITEMS'], 'Import', 'SA_Orders');
}